...
export interface components {
    schemas: {
         ...
         * @example {
         *       "id": "d6ecba3a-1862-40d9-b47d-b27d533c0a3b",
         *       "users_with_role": [
         *         {
         *           "role": "Admin",
         *           "on_resource": "organization",
         *           "linked_by_relation": "owner",
         *           "role_id": "b4cd5688-d280-4d05-a198-80fc66965922",
         *           "resource_id": "b8f20f66-ed3e-4dea-833e-aa64f1ff1571",
         *           "relation_id": "65baa113-e51b-4d16-a633-0da170cf6125"
         *         }
         *       ]
         *     }
         */
         ...
         * RelationBlockRead
         * @example {
         *       "resource_id": "cee23386-77d9-4946-b7a3-f3ba62587efd",
