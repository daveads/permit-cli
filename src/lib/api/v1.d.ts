...
export interface components {
    schemas: {
         ...
         * @example {
         *       "id": "c4cd6852-83d1-467e-8eb2-936b2ae0d401",
         *       "users_with_role": [
         *         {
         *           "role": "Admin",
         *           "on_resource": "organization",
         *           "linked_by_relation": "owner",
         *           "role_id": "d7341c4b-cfe3-4b14-b55b-84e04a8bdfa9",
         *           "resource_id": "a638ab04-dfd9-4428-9c8c-1e31f129359f",
         *           "relation_id": "505f4b18-86cd-40a9-9429-d794cef8e3c9"
         *         }
         *       ]
         *     }
         */
         ...
         * RelationBlockRead
         * @example {
         *       "resource_id": "0c3d0d99-29a3-45fd-b15b-e71a78306e79",
